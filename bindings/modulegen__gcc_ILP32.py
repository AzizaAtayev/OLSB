...
def module_init():
    root_module = Module('ns.olsb', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## olsb-helper.h (module 'olsb'): ns3::OlsbHelper [class]
    module.add_class('OlsbHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace olsb
    
    nested_module = module.add_cpp_namespace('olsb')
    register_types_ns3_olsb(nested_module)
...
def register_types_ns3_olsb(module):
    root_module = module.get_root()
    
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID'])
    ## olsb-packet.h (module 'olsb'): ns3::olsb::OlsbHeader [class]
    module.add_class('OlsbHeader', parent=root_module['ns3::Header'])
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::PacketQueue [class]
    module.add_class('PacketQueue')
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::QueueEntry [class]
    module.add_class('QueueEntry')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ns3::olsb::QueueEntry::UnicastForwardCallback')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::UnicastForwardCallback*', 'ns3::olsb::QueueEntry::UnicastForwardCallback*')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::UnicastForwardCallback&', 'ns3::olsb::QueueEntry::UnicastForwardCallback&')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ns3::olsb::QueueEntry::ErrorCallback')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::ErrorCallback*', 'ns3::olsb::QueueEntry::ErrorCallback*')
    typehandlers.add_type_alias('ns3::Ipv4RoutingProtocol::ErrorCallback&', 'ns3::olsb::QueueEntry::ErrorCallback&')
    ## olsb-routing-protocol.h (module 'olsb'): ns3::olsb::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTable [class]
    module.add_class('RoutingTable')
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    module.add_container('std::map< ns3::Ipv4Address, ns3::olsb::RoutingTableEntry >', ('ns3::Ipv4Address', 'ns3::olsb::RoutingTableEntry'), container_type='map')
...
def register_methods(root_module):
    ...
    register_Ns3OlsbHelper_methods(root_module, root_module['ns3::OlsbHelper'])
    ...
    register_Ns3OlsbOlsbHeader_methods(root_module, root_module['ns3::olsb::OlsbHeader'])
    register_Ns3OlsbPacketQueue_methods(root_module, root_module['ns3::olsb::PacketQueue'])
    register_Ns3OlsbQueueEntry_methods(root_module, root_module['ns3::olsb::QueueEntry'])
    register_Ns3OlsbRoutingProtocol_methods(root_module, root_module['ns3::olsb::RoutingProtocol'])
    register_Ns3OlsbRoutingTable_methods(root_module, root_module['ns3::olsb::RoutingTable'])
    register_Ns3OlsbRoutingTableEntry_methods(root_module, root_module['ns3::olsb::RoutingTableEntry'])
    return
...
def register_Ns3OlsbHelper_methods(root_module, cls):
    ## olsb-helper.h (module 'olsb'): ns3::OlsbHelper::OlsbHelper(ns3::OlsbHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::OlsbHelper const &', 'arg0')])
    ## olsb-helper.h (module 'olsb'): ns3::OlsbHelper::OlsbHelper() [constructor]
    cls.add_constructor([])
    ## olsb-helper.h (module 'olsb'): ns3::OlsbHelper * ns3::OlsbHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::OlsbHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## olsb-helper.h (module 'olsb'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::OlsbHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## olsb-helper.h (module 'olsb'): void ns3::OlsbHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3OlsbOlsbHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## olsb-packet.h (module 'olsb'): ns3::olsb::OlsbHeader::OlsbHeader(ns3::olsb::OlsbHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::OlsbHeader const &', 'arg0')])
    ## olsb-packet.h (module 'olsb'): ns3::olsb::OlsbHeader::OlsbHeader(ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t hopcount=0, uint32_t dstSeqNo=0, uint32_t queueSize=0) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'dst', default_value='ns3::Ipv4Address()'), param('uint32_t', 'hopcount', default_value='0'), param('uint32_t', 'dstSeqNo', default_value='0'), param('uint32_t', 'queueSize', default_value='0')])
    ## olsb-packet.h (module 'olsb'): uint32_t ns3::olsb::OlsbHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## olsb-packet.h (module 'olsb'): ns3::Ipv4Address ns3::olsb::OlsbHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## olsb-packet.h (module 'olsb'): uint32_t ns3::olsb::OlsbHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-packet.h (module 'olsb'): uint32_t ns3::olsb::OlsbHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-packet.h (module 'olsb'): ns3::TypeId ns3::olsb::OlsbHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## olsb-packet.h (module 'olsb'): uint32_t ns3::olsb::OlsbHeader::GetQueueSize() const [member function]
    cls.add_method('GetQueueSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-packet.h (module 'olsb'): uint32_t ns3::olsb::OlsbHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## olsb-packet.h (module 'olsb'): static ns3::TypeId ns3::olsb::OlsbHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::SetDst(ns3::Ipv4Address destination) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'destination')])
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::SetDstSeqno(uint32_t sequenceNumber) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::SetHopCount(uint32_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    ## olsb-packet.h (module 'olsb'): void ns3::olsb::OlsbHeader::SetQueueSize(uint32_t queueSize) [member function]
    cls.add_method('SetQueueSize', 
                   'void', 
                   [param('uint32_t', 'queueSize')])
    return

def register_Ns3OlsbPacketQueue_methods(root_module, cls):
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::PacketQueue::PacketQueue(ns3::olsb::PacketQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::PacketQueue const &', 'arg0')])
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::PacketQueue::PacketQueue() [constructor]
    cls.add_constructor([])
    ## olsb-packet-queue.h (module 'olsb'): bool ns3::olsb::PacketQueue::Dequeue(ns3::Ipv4Address dst, ns3::olsb::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::olsb::QueueEntry &', 'entry')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::PacketQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## olsb-packet-queue.h (module 'olsb'): bool ns3::olsb::PacketQueue::Enqueue(ns3::olsb::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::olsb::QueueEntry &', 'entry')])
    ## olsb-packet-queue.h (module 'olsb'): bool ns3::olsb::PacketQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## olsb-packet-queue.h (module 'olsb'): uint32_t ns3::olsb::PacketQueue::GetCountForPacketsWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetCountForPacketsWithDst', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## olsb-packet-queue.h (module 'olsb'): uint32_t ns3::olsb::PacketQueue::GetMaxPacketsPerDst() const [member function]
    cls.add_method('GetMaxPacketsPerDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): uint32_t ns3::olsb::PacketQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): ns3::Time ns3::olsb::PacketQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): uint32_t ns3::olsb::PacketQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::PacketQueue::SetMaxPacketsPerDst(uint32_t len) [member function]
    cls.add_method('SetMaxPacketsPerDst', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::PacketQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::PacketQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3OlsbQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::QueueEntry::QueueEntry(ns3::olsb::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::QueueEntry const &', 'arg0')])
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::olsb::QueueEntry::UnicastForwardCallback ucb=ns3::olsb::QueueEntry::UnicastForwardCallback(), ns3::olsb::QueueEntry::ErrorCallback ecb=ns3::olsb::QueueEntry::ErrorCallback()) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::olsb::QueueEntry::UnicastForwardCallback', 'ucb', default_value='ns3::olsb::QueueEntry::UnicastForwardCallback()'), param('ns3::olsb::QueueEntry::ErrorCallback', 'ecb', default_value='ns3::olsb::QueueEntry::ErrorCallback()')])
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::QueueEntry::ErrorCallback ns3::olsb::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::olsb::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): ns3::Time ns3::olsb::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): ns3::Ipv4Header ns3::olsb::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): ns3::Ptr<const ns3::Packet> ns3::olsb::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): ns3::olsb::QueueEntry::UnicastForwardCallback ns3::olsb::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::olsb::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::QueueEntry::SetErrorCallback(ns3::olsb::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## olsb-packet-queue.h (module 'olsb'): void ns3::olsb::QueueEntry::SetUnicastForwardCallback(ns3::olsb::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3OlsbRoutingProtocol_methods(root_module, cls):
    ## olsb-routing-protocol.h (module 'olsb'): ns3::olsb::RoutingProtocol::RoutingProtocol(ns3::olsb::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::RoutingProtocol const &', 'arg0')])
    ## olsb-routing-protocol.h (module 'olsb'): ns3::olsb::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## olsb-routing-protocol.h (module 'olsb'): int64_t ns3::olsb::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): double ns3::olsb::RoutingProtocol::GetBackpressureFactor() const [member function]
    cls.add_method('GetBackpressureFactor', 
                   'double', 
                   [], 
                   is_const=True)
    ## olsb-routing-protocol.h (module 'olsb'): bool ns3::olsb::RoutingProtocol::GetEnableBufferFlag() const [member function]
    cls.add_method('GetEnableBufferFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## olsb-routing-protocol.h (module 'olsb'): bool ns3::olsb::RoutingProtocol::GetEnableRAFlag() const [member function]
    cls.add_method('GetEnableRAFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## olsb-routing-protocol.h (module 'olsb'): double ns3::olsb::RoutingProtocol::GetShortestPathFactor() const [member function]
    cls.add_method('GetShortestPathFactor', 
                   'double', 
                   [], 
                   is_const=True)
    ## olsb-routing-protocol.h (module 'olsb'): static ns3::TypeId ns3::olsb::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## olsb-routing-protocol.h (module 'olsb'): bool ns3::olsb::RoutingProtocol::GetWSTFlag() const [member function]
    cls.add_method('GetWSTFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): bool ns3::olsb::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): ns3::Ptr<ns3::Ipv4Route> ns3::olsb::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetBackpressureFactor(double factor) [member function]
    cls.add_method('SetBackpressureFactor', 
                   'void', 
                   [param('double', 'factor')])
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetEnableBufferFlag(bool f) [member function]
    cls.add_method('SetEnableBufferFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetEnableRAFlag(bool f) [member function]
    cls.add_method('SetEnableRAFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetShortestPathFactor(double factor) [member function]
    cls.add_method('SetShortestPathFactor', 
                   'void', 
                   [param('double', 'factor')])
    ## olsb-routing-protocol.h (module 'olsb'): void ns3::olsb::RoutingProtocol::SetWSTFlag(bool f) [member function]
    cls.add_method('SetWSTFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## olsb-routing-protocol.h (module 'olsb'): ns3::olsb::RoutingProtocol::OLSB_PORT [variable]
    cls.add_static_attribute('OLSB_PORT', 'uint32_t const', is_const=True)
    return

def register_Ns3OlsbRoutingTable_methods(root_module, cls):
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTable::RoutingTable(ns3::olsb::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::RoutingTable const &', 'arg0')])
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTable::RoutingTable() [constructor]
    cls.add_constructor([])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::AddIpv4Event(ns3::Ipv4Address address, ns3::EventId id) [member function]
    cls.add_method('AddIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address'), param('ns3::EventId', 'id')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::AddRoute(ns3::olsb::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::olsb::RoutingTableEntry &', 'r')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::AnyRunningEvent(ns3::Ipv4Address address) [member function]
    cls.add_method('AnyRunningEvent', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::DeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('DeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::ForceDeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('ForceDeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## olsb-rtable.h (module 'olsb'): ns3::EventId ns3::olsb::RoutingTable::GetEventId(ns3::Ipv4Address address) [member function]
    cls.add_method('GetEventId', 
                   'ns3::EventId', 
                   [param('ns3::Ipv4Address', 'address')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::GetListOfAllRoutes(std::map<ns3::Ipv4Address, ns3::olsb::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::olsb::RoutingTableEntry>>> & allRoutes) [member function]
    cls.add_method('GetListOfAllRoutes', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::olsb::RoutingTableEntry > &', 'allRoutes')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nxtHp, std::map<ns3::Ipv4Address, ns3::olsb::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::olsb::RoutingTableEntry>>> & dstList) [member function]
    cls.add_method('GetListOfDestinationWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nxtHp'), param('std::map< ns3::Ipv4Address, ns3::olsb::RoutingTableEntry > &', 'dstList')])
    ## olsb-rtable.h (module 'olsb'): ns3::Time ns3::olsb::RoutingTable::Getholddowntime() const [member function]
    cls.add_method('Getholddowntime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::olsb::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::olsb::RoutingTableEntry &', 'rt')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::LookupRoute(ns3::Ipv4Address id, ns3::olsb::RoutingTableEntry & rt, bool forRouteInput) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::olsb::RoutingTableEntry &', 'rt'), param('bool', 'forRouteInput')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::Purge(std::map<ns3::Ipv4Address, ns3::olsb::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::olsb::RoutingTableEntry>>> & removedAddresses) [member function]
    cls.add_method('Purge', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::olsb::RoutingTableEntry > &', 'removedAddresses')])
    ## olsb-rtable.h (module 'olsb'): uint32_t ns3::olsb::RoutingTable::RoutingTableSize() [member function]
    cls.add_method('RoutingTableSize', 
                   'uint32_t', 
                   [])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTable::Setholddowntime(ns3::Time t) [member function]
    cls.add_method('Setholddowntime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTable::Update(ns3::olsb::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::olsb::RoutingTableEntry &', 'rt')])
    return

def register_Ns3OlsbRoutingTableEntry_methods(root_module, cls):
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTableEntry::RoutingTableEntry(ns3::olsb::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::olsb::RoutingTableEntry const &', 'arg0')])
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint32_t hops=0, uint32_t qsize=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now(), ns3::Time SettlingTime=ns3::Simulator::Now(), bool changedEntries=false) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::NetDevice >', 'dev', default_value='0'), param('ns3::Ipv4Address', 'dst', default_value='ns3::Ipv4Address()'), param('uint32_t', 'seqNo', default_value='0'), param('ns3::Ipv4InterfaceAddress', 'iface', default_value='ns3::Ipv4InterfaceAddress()'), param('uint32_t', 'hops', default_value='0'), param('uint32_t', 'qsize', default_value='0'), param('ns3::Ipv4Address', 'nextHop', default_value='ns3::Ipv4Address()'), param('ns3::Time', 'lifetime', default_value='ns3::Simulator::Now()'), param('ns3::Time', 'SettlingTime', default_value='ns3::Simulator::Now()'), param('bool', 'changedEntries', default_value='false')])
    ## olsb-rtable.h (module 'olsb'): ns3::Ipv4Address ns3::olsb::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): bool ns3::olsb::RoutingTableEntry::GetEntriesChanged() const [member function]
    cls.add_method('GetEntriesChanged', 
                   'bool', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::olsb::RouteFlags ns3::olsb::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::olsb::RouteFlags', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): uint32_t ns3::olsb::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Ipv4InterfaceAddress ns3::olsb::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Time ns3::olsb::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Ipv4Address ns3::olsb::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Ptr<ns3::NetDevice> ns3::olsb::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): uint32_t ns3::olsb::RoutingTableEntry::GetQueueSize() const [member function]
    cls.add_method('GetQueueSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Ptr<ns3::Ipv4Route> ns3::olsb::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): uint32_t ns3::olsb::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): ns3::Time ns3::olsb::RoutingTableEntry::GetSettlingTime() const [member function]
    cls.add_method('GetSettlingTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True)
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetEntriesChanged(bool entriesChanged) [member function]
    cls.add_method('SetEntriesChanged', 
                   'void', 
                   [param('bool', 'entriesChanged')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetFlag(ns3::olsb::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::olsb::RouteFlags', 'flag')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetHop(uint32_t hopCount) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetLifeTime(ns3::Time lifeTime) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lifeTime')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> device) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'device')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetQueueSize(uint32_t qsize) [member function]
    cls.add_method('SetQueueSize', 
                   'void', 
                   [param('uint32_t', 'qsize')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetSeqNo(uint32_t sequenceNumber) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## olsb-rtable.h (module 'olsb'): void ns3::olsb::RoutingTableEntry::SetSettlingTime(ns3::Time settlingTime) [member function]
...
def register_functions(root_module):
    ...
    register_functions_ns3_olsb(module.add_cpp_namespace('olsb'), root_module)
    return
...
def register_functions_ns3_olsb(module, root_module):
    return
